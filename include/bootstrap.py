...
def bootstrapping(ents_embedding, ref_pairs, labeled_alignment, th, boot_K):
    print('##### bootstrapping ####')
    ref_ent1_list = [e1 for e1, e2 in ref_pairs]
    ref_ent2_list = [e2 for e1, e2 in ref_pairs]
    # sim_mat
    ...
    curr_labeled_alignment = find_potential_alignment(ref_sim_mat, th, boot_K, n)
